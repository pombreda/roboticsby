...
cl /EHsc /D "_USING_V110_SDK71_" /D "_CONSOLE" /D "_UNICODE" /D "UNICODE" /arch:SSE2 /O1 ..\src\tigger_joystick_keyboard_module_test.cpp /link Winmm.lib user32.lib /SUBSYSTEM:CONSOLE",5.01"
cl /EHsc /D "_USING_V110_SDK71_" /D "_CONSOLE" /D "_UNICODE" /D "UNICODE" /arch:SSE2 /O1 ..\src\system_information_detection_module_test.cpp /SUBSYSTEM:CONSOLE",5.01"
cl /EHsc /D "_USING_V110_SDK71_" /D "_UNICODE" /D "UNICODE" /arch:SSE2  /D "WIN32" /D "_WINDOWS" /O1 ..\src\system_information_detection_module_test_win.cpp /link user32.lib gdi32.lib kernel32.lib 
