...
static void ScalePlaneDown2_16(int , int ,
                               int dst_width, int dst_height,
                               int src_stride, int dst_stride,
...
static void ScalePlaneDown4_16(int , int ,
                               int dst_width, int dst_height,
                               int src_stride, int dst_stride,
                               const uint16* src_ptr, uint16* dst_ptr,
                               enum FilterMode filtering) {
...
static void ScalePlaneDown34_16(int , int ,
                                int dst_width, int dst_height,
                                int src_stride, int dst_stride,
                                const uint16* src_ptr, uint16* dst_ptr,
                                enum FilterMode filtering) {
...
static void ScalePlaneDown38_16(int , int ,
                                int dst_width, int dst_height,
                                int src_stride, int dst_stride,
                                const uint16* src_ptr, uint16* dst_ptr,
                                enum FilterMode filtering) {
