...
void ScaleRowDown2_C(const uint8* src_ptr, ptrdiff_t ,
...
void ScaleRowDown2_16_C(const uint16* src_ptr, ptrdiff_t ,
...
void ScaleRowDown2Linear_C(const uint8* src_ptr, ptrdiff_t ,
                           uint8* dst, int dst_width) {
...
void ScaleRowDown2Linear_16_C(const uint16* src_ptr, ptrdiff_t ,
                              uint16* dst, int dst_width) {
...
void ScaleRowDown4_C(const uint8* src_ptr, ptrdiff_t ,
                     uint8* dst, int dst_width) {
  int x;
  for (x = 0; x < dst_width - 1; x += 2) {
    dst[0] = src_ptr[2];
...
void ScaleRowDown4_16_C(const uint16* src_ptr, ptrdiff_t ,
                        uint16* dst, int dst_width) {
  int x;
  for (x = 0; x < dst_width - 1; x += 2) {
    dst[0] = src_ptr[2];
...
void ScaleRowDown34_C(const uint8* src_ptr, ptrdiff_t ,
                      uint8* dst, int dst_width) {
  int x;
...
void ScaleRowDown34_16_C(const uint16* src_ptr, ptrdiff_t ,
                         uint16* dst, int dst_width) {
  int x;
  assert((dst_width % 3 == 0) && (dst_width > 0));
  for (x = 0; x < dst_width; x += 3) {
...
void ScaleRowDown38_C(const uint8* src_ptr, ptrdiff_t ,
                      uint8* dst, int dst_width) {
  int x;
...
void ScaleRowDown38_16_C(const uint16* src_ptr, ptrdiff_t ,
                         uint16* dst, int dst_width) {
  int x;
  assert(dst_width % 3 == 0);
  for (x = 0; x < dst_width; x += 3) {
...
void ScaleARGBRowDownEven_C(const uint8* src_argb, ptrdiff_t ,
                            int src_stepx,
                            uint8* dst_argb, int dst_width) {
  const uint32* src = (const uint32*)(src_argb);
  uint32* dst = (uint32*)(dst_argb);
