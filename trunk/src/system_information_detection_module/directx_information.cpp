...
HRESULT GetDXVersion( DWORD* pdwDirectXVersion, WCHAR* strDirectXVersion, SIZE_T cchDirectXVersion = 10 )
{
    BOOL bGotDirectXVersion = false;  
    ...
    cDirectXVersionLetter = static_cast<WCHAR>(tolower(cDirectXVersionLetter));
